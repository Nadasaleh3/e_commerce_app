...
import '../views/pages/home1.dart';

class ProductProvider extends ChangeNotifier {
  List<Map<String, dynamic>> categoriesData1 = [
    {'title': 'women\'s clothing', 'image': 'assets/w.png'},
    {'title': 'men\'s clothing' , 'image': 'assets/m.png'},
    {'title': 'electronics',  'image': 'assets/e1.png'},
    {'title': 'jewelery', 'image': 'assets/j.png'},
  ];
  ...
  void getAllProductsHandler() async {
    ...
    void getBestProductsHandler() async {
    clearBestProductList();
    _bestProducts = await ProductService.getProducts(limit: 5);
    _bestProducts?.shuffle();
    notifyListeners();
  }
